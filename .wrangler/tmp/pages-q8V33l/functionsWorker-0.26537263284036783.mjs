  ...
  try {
    ...
    const resendResponse = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        // Zmień to dopiero jak zweryfikujesz domenę!
        to: "marcin.chowaniec@outlook.com",
        // <--- WPISZ TU SWÓJ E-MAIL!
        subject: `Wesele RSVP: ${name}`,
        html: `<p><strong>Go\u015B\u0107:</strong> ${name}</p><p><strong>Liczba os\xF3b:</strong> ${guestCount}</p><p><strong>Komentarz:</strong> ${comment}</p>`
      })
    });
...
// ../.wrangler/tmp/pages-q8V33l/functionsRoutes-0.25044264519408144.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-fNaXcS/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-fNaXcS/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.26537263284036783.mjs.map
